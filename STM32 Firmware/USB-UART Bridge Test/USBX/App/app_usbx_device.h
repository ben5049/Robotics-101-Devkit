...
#define UX_DEVICE_APP_THREAD_STACK_SIZE   2*1024
#define UX_DEVICE_APP_THREAD_PRIO         20

/* USER CODE BEGIN EC */
#define UX_DEVICE_CDC_ACM_THREAD_STACK_SIZE  1024
#define UX_DEVICE_CDC_ACM_THREAD_PRIO        22
/* USER CODE END EC */
...
#ifndef UX_DEVICE_CDC_ACM_THREAD_NAME
#define UX_DEVICE_CDC_ACM_THREAD_NAME  "USBX Device CDC ACM Thread"
#endif

#ifndef UX_DEVICE_CDC_ACM_THREAD_PREEMPTION_THRESHOLD
#define UX_DEVICE_CDC_ACM_THREAD_PREEMPTION_THRESHOLD  UX_DEVICE_CDC_ACM_THREAD_PRIO
#endif

#ifndef UX_DEVICE_CDC_ACM_THREAD_TIME_SLICE
#define UX_DEVICE_CDC_ACM_THREAD_TIME_SLICE  TX_NO_TIME_SLICE
#endif

#ifndef UX_DEVICE_CDC_ACM_THREAD_START_OPTION
#define UX_DEVICE_CDC_ACM_THREAD_START_OPTION  TX_AUTO_START
#endif
